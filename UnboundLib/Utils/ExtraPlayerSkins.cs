...
namespace Unbound.Core.Utils
{
    public static class ExtraPlayerSkins
    {
        ...
        internal static readonly TableRefHelper TeamColorNames = new TableRefHelper(UnboundCore.ModId).UpdateSrting("Team_0_Name", new TableRefHelper.TranslationData()
        {
            en_US = "Orange"
        ...
        {
            return TeamColorNames.GenerateString(TableRefHelper.stringTableDefault, $"Team_{teamID}_Name");
        }
        ...
        public static PlayerSkin GetPlayerSkinColors(int colorID)
        {
            ...
            PlayerSkin skinToSet = extraSkinBases[colorID];
