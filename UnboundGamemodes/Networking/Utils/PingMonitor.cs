...
namespace Unbound.Gamemodes.Networking.Utils{
    ...
    public class PingMonitor : MonoBehaviourPunCallbacks
    {
        ...
        public override void OnPlayerPropertiesUpdate(Photon.Realtime.Player targetPlayer, Hashtable changedProps)
        {
            ...
            if (!changedProps.TryGetValue("Ping", out object ping)) return;
        ...
        public Player[] GetPlayersByOwnerActorNumber(int actorNumber)
        {
            ...
            Player[] players = PlayerManager.instance.players.Where(player => player.data.view.OwnerActorNr == actorNumber).ToArray();
        ...
        {
            Color gradient = GetColorGradient(Normalize(ping, 40, 220, 0, 1));
