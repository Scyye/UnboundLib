    ...
    public class CharacterSelectionMenuLayoutGroup : MonoBehaviour
   {
        ...
        void Update()
       {
            ...
            for (int i = 0; i < players; i++)
           {
            ...
            // update the layout
            float scale = UnityEngine.Mathf.Lerp(maxSize, minSize, (float) (players) / (float) (maxCols));
            float Hspacing = UnityEngine.Mathf.Lerp(maxHSpacing, minHSpacing, (float) (players) / (float) (maxCols));
