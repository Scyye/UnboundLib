    ...
    public static class KeybindHints
   {
        ...
        public static GameObject KeybindHintHolder
       {
            get
           {
                ...
                var fitter = _KeybindHintsHolder.GetOrAddComponent<ContentSizeFitter>();
                fitter.verticalFit = ContentSizeFitter.FitMode.PreferredSize;
                fitter.horizontalFit = ContentSizeFitter.FitMode.PreferredSize;
                var layoutgroup = _KeybindHintsHolder.GetOrAddComponent<VerticalLayoutGroup>();
        ...
        public static GameObject KeybindPrefab
       {
            get
           {
                ...
                var sizer = _KeybindPrefab.GetOrAddComponent<ContentSizeFitter>();
                sizer.horizontalFit = ContentSizeFitter.FitMode.PreferredSize;
                sizer.verticalFit = ContentSizeFitter.FitMode.PreferredSize;

                var text = _KeybindPrefab.GetOrAddComponent<TextMeshProUGUI>();
                text.fontSize = 30;
